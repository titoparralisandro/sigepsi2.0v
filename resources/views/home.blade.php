		...
		<div class="fixed">
			<header>
				<div class="menu">
					<div class="logo">
						<div class="img-logo">
							<img src="vendor/adminlte/dist/img/AdminLTELogo.png" style="width: 15%;">
							<strong style="color: rgba(0,0,0,.7);">SIGEPSI</strong>
						</div>
					</div>
				</div>
			</header>
			<div class="principal">
				<h2 class="animate__animated animate__backInDown">
					<strong style="color: rgba(0,0,0,.7);">Sistema de Gestión de Proyectos Socio Integradores de la Universidad Politécnica Territorial de Caracas "Mariscal Sucre"</strong>
				</h2>
				<p class="animate__animated animate__backInLeft" style="color: rgba(0,0,0,.7);">
