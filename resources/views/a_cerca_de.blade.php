...
<div class="card">
	<div class="container">
		...
		<h1 style="text-align: center; padding-top: 30px; color: rgba(0,0,0,.7); font-size: 30px;">
		<strong>Acerca del Sistema de Gestion de Proyectos Socio Integradores </strong><span class="badge bg-success">v2.0</span>
		</h1>
		
		<p style="font-size: 16px; text-align: justify; color: rgba(0,0,0,.8); text-indent: 5%; width: 93%; margin: auto; padding-top: 15px; padding-bottom: 15px;">
	...
	<div class="row" style="display: flex; justify-content: space-around;">
		<div class="col-sm-5 card text-center">
			...
			<p style="color: rgba(0,0,0,.7); font-size: 15px;">
				<i class="fas fa-fw fa-user-tie"></i> Msc. Alfredo Agreda, <i class="fas fa-fw fa-user-tie"></i> Lic. Edwuard Castañeda, <i class="fas fa-fw fa-user-tie"></i> Ing. Osman Pérez.
			</p>
		</div>
