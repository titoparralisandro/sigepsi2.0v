...
<div class="card-header bg-primary ">
  <div class="color-palette">
    <h1 class="text-center"><strong>Carreras</strong></h1>
  </div>
</div>
...
<div class="card border-dark">
  ...
  <div class="card-body text-dark">
    <a class="btn btn-success" href="{{ route('carrera.create') }}">Añadir nueva carrera</a>
    <hr>
                  <table id="example1" class="table table-head-fixed text-nowrap ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $carreras->estatus==true ? ('Activo') : ('Inactivo') }} </td>
                        <td><a class="btn btn-primary" href="{{ route('carrera.show', $carreras->id ) }}">Ver</a> | <a class="btn btn-info" href="{{ route('carrera.edit', $carreras->id ) }}">Editar</a></td>
