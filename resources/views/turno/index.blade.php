...
<div class="card-header bg-primary">
  <div class="color-palette">
    <h1 class="text-center"><strong>Turnos</strong></h1>
  </div>
</div>
...
<div class="card border-dark">
  ...
  <div class="card-body text-dark">
    <a class="btn btn-success" href="{{ route('turno.create') }}">Añadir nuevo turno</a>
    <hr>
                  <table id="example1" class="table table-head-fixed text-nowrap ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $turnos->id }}</td>
                        <td>{{ $turnos->turno }}</td>
                        <td>{{ $turnos->estatus==true ? ('Activo') : ('Inactivo') }} </td>
                        <td><a class="btn btn-primary" href="{{ route('turno.show', $turnos->id ) }}">Ver</a> | <a class="btn btn-info" href="{{ route('turno.edit', $turnos->id ) }}">Editar</a></td>
                      </tr>
                      @endforeach
