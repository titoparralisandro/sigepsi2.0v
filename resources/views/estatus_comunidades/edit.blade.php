...
<div class="card-header bg-primary ">
    ...
    <div class="color-palette">
      <h1 class="text-center"><strong>Actualización de estatus de comunidad</strong></h1>
    </div>
</div>
  ...
  <div class="card border-dark">
    ...
    <div class="card-body text-dark">
        ...
        <form action="{{ route('estatus_comunidades.update', $estatus_comunidad->id ) }}" method="POST">
