...
class NecesidadeController extends Controller
{
    ...
    public function edit($id){
       ...
       foreach ($estados as $estadoss) {
        ...
        return view('necesidad.edit',['html'=>$html, 'a'=>$a, "necesidad"=>$necesidad, "estados"=>$estados, "municipios"=>$municipios , "parroquias"=>$parroquias]);
     ...
     public function update(Request $request, $id){
        ...
        $necesidad->id_estatus_necesidad= $request->get('estatus');

        $necesidad->save();

         return redirect('/necesidad')->with('respuesta','editado');
     }
    ...
    public function banca_create (Request $request){
        ...
        $necesidad->id_estatus_necesidad= 3;
        $necesidad->save();
